...
export class PresetsService {
  ...
  getCategories(): Array<{id: ConfigPreset['category'], label: string, description: string}> {
    return [
      { id: 'theme',        label: 'Color Themes', description: 'Palette and selection colors' },
      { id: 'minimal',      label: 'Minimal',      description: 'Strip the chrome, keep the cells' },
      { id: 'performance',  label: 'Performance',  description: 'Lower latency, fewer redraws' },
      { id: 'gaming',       label: 'Gaming',       description: 'Tightest input loop for fast UIs' },
      { id: 'feature-rich', label: 'Power User',   description: 'Everything turned on' },
    ];
  }
}
