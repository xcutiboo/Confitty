...
const tabColors = (
	activeBg: string,
	activeFg: string = "#000000",
	inactiveBg: string = "#999999",
	inactiveFg: string = "#444444",
) => ({
...
export class PresetsService {
	private readonly presets: ConfigPreset[] = [
		...
		preset(
			"confitty",
			"Confitty",
			"Official Confitty theme with soft pinks and confetti accents",
			"theme",
			"Confitty",
			["official", "pastel", "cat"],
			{
		...
		preset(
			"catppuccin-mocha",
			"Catppuccin Mocha",
			"Soothing pastel dark theme, warm and cozy",
			"theme",
			"Catppuccin",
			["dark", "pastel", "modern", "popular"],
			{
				...baseTheme,
				...themeColors(
					"#cdd6f4",
		...
		preset(
			"catppuccin-latte",
			"Catppuccin Latte",
			"Soothing pastel light theme, clean and bright",
			"theme",
			"Catppuccin",
			["light", "pastel", "modern"],
			{
		...
		preset(
			"tokyo-night",
			"Tokyo Night",
			"Dark theme inspired by the Tokyo night sky",
			"theme",
			"Tokyo Night",
			["dark", "blue", "modern", "popular"],
			{
				...baseTheme,
				...themeColors(
					"#c0caf5",
		...
		preset(
			"rose-pine",
			"Rose Pine",
			"All natural pine with soho vibes",
			"theme",
			"Rose Pine",
			["dark", "soft", "aesthetic"],
			{
		...
		preset(
			"kanagawa",
			"Kanagawa",
			"Dark theme inspired by Hokusai paintings",
			"theme",
			"Kanagawa",
			["dark", "artistic", "japanese"],
			{
				...baseTheme,
				...themeColors(
					"#dcd7ba",
		...
		preset(
			...
			"Performance Optimized",
			"Maximum speed for resource-constrained systems",
			"performance",
			undefined,
		...
		preset(
			"minimal-clean",
			"Minimal & Clean",
			"Distraction-free setup for focused work",
			"minimal",
			undefined,
		...
		preset(
			"developer-default",
			"Developer Default",
			"Balanced configuration for development workflows",
			"feature-rich",
			undefined,
			["developer", "balanced", "productivity"],
			{
				font_family: "JetBrains Mono",
				font_size: 12,
				disable_ligatures: "cursor",
		...
		preset(
			"gaming-responsive",
			"Gaming & Responsive",
			"Ultra-low latency for gaming and real-time apps",
			"gaming",
			undefined,
			["gaming", "fast", "low-latency"],
			{
				repaint_delay: 3,
				input_delay: 0,
				sync_to_monitor: true,
		...
		preset(
			"streaming",
			"Streaming/Recording",
			"Optimized for screen recording and streaming",
			"feature-rich",
			undefined,
		...
		preset(
			...
			"Enhanced accessibility settings with high visibility",
			"feature-rich",
			undefined,
			["accessibility", "a11y", "readable"],
			{
				font_family: "JetBrains Mono",
				font_size: 14,
				disable_ligatures: "always",
		...
		preset(
			"presentation",
			"Presentation Mode",
			"Large fonts for demos and screen sharing",
			"feature-rich",
			undefined,
			["presentation", "demo", "large-font"],
			{
				font_family: "JetBrains Mono",
				font_size: 16,
				disable_ligatures: "always",
		...
		preset(
			"remote-server",
			"Remote Server",
			"Optimized for SSH and remote connections",
			"performance",
			undefined,
			["remote", "ssh", "server"],
			{
		...
		return [
			{
				id: "theme",
				label: "Color Themes",
				description: "Palette and selection colors",
			},
			{
				id: "minimal",
				label: "Minimal",
				description: "Strip the chrome, keep the cells",
			},
			{
				id: "performance",
				label: "Performance",
				description: "Lower latency, fewer redraws",
			},
			{
				id: "gaming",
				label: "Gaming",
				description: "Tightest input loop for fast UIs",
			},
			{
				id: "feature-rich",
				label: "Power User",
				description: "Everything turned on",
			},
		];
	}
}
