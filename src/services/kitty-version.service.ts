...
export class KittyVersionService {
  readonly versions: KittyVersion[] = [
    ...
    { version: '0.45.0', label: '0.45.0', description: 'Linux stable' },
    { version: '0.46.1', label: '0.46.1', description: 'Debian testing' },
    { version: '0.46.2', label: '0.46.2', description: 'macOS stable' },
    { version: '0.47.0', label: '0.47.0', description: 'Latest. Adds progress bar, auto-reload, palette generate.' },
  ];
  ...
  readonly featureRequirements: Record<string, FeatureRequirement> = {
    ...
    scrollbar_gap: { minVersion: '0.43.0', description: 'Gap between scrollbar and screen', warning: 'In cell widths' },
    scrollbar_handle_color: { minVersion: '0.43.0', description: 'Color of the scrollbar handle' },
    scrollbar_handle_opacity: { minVersion: '0.43.0', description: 'Opacity of scrollbar handle' },
    scrollbar_hitbox_expansion: { minVersion: '0.43.0', description: 'Extra hit zone around handle' },
    scrollbar_hover_width: { minVersion: '0.43.0', description: 'Handle width while hovering' },
    scrollbar_interactive: { minVersion: '0.43.0', description: 'Allow click-and-drag scrolling' },
    scrollbar_jump_on_click: { minVersion: '0.43.0', description: 'Jump on track click' },
    scrollbar_min_handle_height: { minVersion: '0.43.0', description: 'Minimum handle height' },
    scrollbar_radius: { minVersion: '0.43.0', description: 'Corner rounding for scrollbar' },
    scrollbar_track_color: { minVersion: '0.43.0', description: 'Color of the scrollbar track' },
    scrollbar_track_hover_opacity: { minVersion: '0.43.0', description: 'Track opacity while hovering' },
    scrollbar_track_opacity: { minVersion: '0.43.0', description: 'Default track opacity' },
    scrollbar_width: { minVersion: '0.43.0', description: 'Scrollbar width', warning: 'In cell widths' },
    placement_strategy: {
      minVersion: '0.14.2',
    ...
    file_transfer_confirmation_bypass: {
      ...
      warning: 'Security risk. Use on trusted connections only.'
    },
    linux_bell_theme: {
      minVersion: '0.28.0',
    ...
    palette_generate: {
      minVersion: '0.47.0',
      description: 'Generate the extended 256-color palette from the first 16 colors',
      warning: 'Saves having to define color16..color255 manually'
    },
    progress_bar: {
      minVersion: '0.47.0',
      description: 'Show OSC 9;4 progress at the top of the window',
      warning: 'Set to "no" to hide the indicator'
    },
    auto_reload_config: {
      minVersion: '0.47.0',
      description: 'Re-apply kitty.conf automatically when it changes on disk',
      warning: 'No restart needed after edits'
    },
    macos_fullscreen_ignore_safe_area_insets: {
      minVersion: '0.47.0',
      description: 'Ignore the notch safe-area in fullscreen on macOS',
      warning: 'macOS only'
    }
  };
  ...
  readonly breakingChanges: Record<string, string[]> = {
    '0.21.0': ['terminal_select_modifiers, rectangle_select_modifiers, open_url_modifiers removed. Use mouse_map instead.'],
    '0.22.0': ['background_opacity no longer affects background_image'],
    '0.26.0': ['adjust_baseline, adjust_line_height, adjust_column_width deprecated. Use modify_font instead.'],
    '0.36.3': ['second_transparent_bg removed. Use transparent_background_colors instead.'],
    '0.43.0': ['scrollback_indicator_opacity replaced by scrollbar'],
    '0.47.0': [
      'scroll_line_up/down now smooth-scroll by default; remap to restore stepwise scrolling',
      'focus_follows_mouse only switches windows on boundary crossing, not continuous motion'
    ]
  };
