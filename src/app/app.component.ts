    ...
    <div class="h-screen bg-kitty-darker text-kitty-text flex flex-col overflow-hidden">
      ...
      <footer class="bg-kitty-surface border-t border-kitty-border px-4 lg:px-8 py-3 lg:py-4 flex-shrink-0">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-6">
          <p class="text-2xs lg:text-xs text-kitty-text-dim text-center lg:text-left leading-relaxed">
          ...
          <button
            type="button"
            (click)="openKofi()"
            class="inline-flex items-center gap-2 px-3.5 lg:px-4 py-2 rounded-lg text-2xs lg:text-xs font-semibold bg-kitty-primary text-kitty-dark hover:bg-kitty-primary-hover transition-colors flex-shrink-0"
          >
