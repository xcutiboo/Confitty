    ...
    >
      <div class="form-group">
        <label class="block text-sm font-medium text-kitty-text mb-2">
          ...
          <span class="text-kitty-accent font-bold ml-2">{{
            scrollback().scrollback_lines.toLocaleString()
          }}</span>
      ...
      <div class="form-group">
        <label class="block text-sm font-medium text-kitty-text mb-2">
          ...
          <span class="text-kitty-accent font-bold ml-2"
            >{{ scrollback().wheel_scroll_multiplier }}x</span
          >
        </label>
        <app-slider-input
        ...
        <div class="mt-6 pt-6 border-t border-kitty-border space-y-6">
            ...
            <div class="flex items-center gap-2 mb-2">
              <label class="block text-sm font-medium text-kitty-text">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Show scrollbar in scrollback buffer (replaces scrollback_indicator_opacity)</span
                >
              </label>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >MB of history passed to pager (0 = unlimited)</span
                >
              </label>
              <app-number-input
          ...
          <div class="form-group" [class.opacity-60]="!scrollbackPagerAvailable()">
            <div class="flex items-center gap-2 mb-2">
              <label class="block text-sm font-medium text-kitty-text">
                Scrollback Pager
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Command to open scrollback in a pager</span
                >
              </label>
          ...
          <div class="form-group">
            <label class="block text-sm font-medium text-kitty-text mb-2">
              ...
              <span class="text-kitty-accent font-bold ml-2"
                >{{ scrollback().touch_scroll_multiplier }}x</span
              >
            </label>
            <app-slider-input
              ...
              <label class="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-kitty-text-dim text-xs mt-0.5">
                    Smooth pixel-by-pixel scrolling with high precision mice
                  </p>
                </div>
              </label>
            ...
            <div class="flex items-center gap-2 mb-2">
              <label class="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-kitty-text-dim text-xs mt-0.5">
                    Inertial scrolling on touchpads (like macOS)
                  </p>
                </div>
              </label>
            ...
            <label class="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                <span class="text-sm font-medium text-kitty-text"
                  >Fill Enlarged Window with Scrollback</span
                >
                <p class="text-kitty-text-dim text-xs mt-0.5">
                  When the window is resized to be larger, fill empty space with scrollback history
                </p>
              </div>
            </label>
          </div>
