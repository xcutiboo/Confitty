      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="form-group">
          <label class="block text-sm font-medium text-kitty-text mb-2">
            ...
            <span class="text-kitty-text-dim text-xs ml-2"
              >Seconds idle before cursor hides (0 = never, -1 = hide on keypress)</span
            >
          </label>
          <app-number-input
        ...
        <div class="form-group">
          <label class="block text-sm font-medium text-kitty-text mb-2">
            Copy on Select
            <span class="text-kitty-text-dim text-xs ml-2"
              >Auto-copy selected text to clipboard</span
            >
          </label>
          <select
          ...
          <label class="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <p class="text-kitty-text-dim text-xs mt-0.5">
                Detect and underline URLs, allowing Ctrl+click to open them
              </p>
            </div>
          </label>
        </div>
        ...
        <div class="form-group">
          <label class="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <p class="text-kitty-text-dim text-xs mt-0.5">
                Focus the window or pane the mouse cursor is hovering over
              </p>
            </div>
          </label>
        </div>
      ...
      @if (helper.advancedMode()) {
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                Open URL With
                <span class="text-kitty-text-dim text-xs ml-2"
                  >'default' uses your OS default browser</span
                >
              </label>
              <input
                type="text"
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                URL Prefixes
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Comma-separated list of URL schemes to detect</span
                >
              </label>
              <input
                type="text"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-kitty-text-dim text-xs mt-0.5">
                    Show the target of OSC 8 hyperlinks in the status bar
                  </p>
                </div>
              </label>
            </div>
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >When to underline OSC 8 hyperlinks</span
                >
              </label>
              <select
        ...
        <div class="bg-kitty-surface rounded-lg p-6 border border-kitty-border">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                Paste Actions
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Actions on paste, comma-separated</span
                >
              </label>
              <input
                type="text"
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                Click Interval
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Max time between clicks for double/triple click (seconds)</span
                >
              </label>
              <app-number-input
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Additional characters for word selection when moving forward</span
                >
              </label>
              <input
                type="text"
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2"
                >Pointer Shape When Grabbed</label
              >
              <select
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2"
                >Pointer Shape When Dragging</label
              >
              <select
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Remove trailing whitespace when copying</span
                >
              </label>
              <select
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Characters treated as part of a word on double-click</span
                >
              </label>
              <input
                type="text"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Characters to exclude from URL detection</span
                >
              </label>
              <input
                type="text"
              ...
              <div class="flex items-center gap-2 mb-2">
                <label class="flex items-center gap-3 cursor-pointer h-full">
                  <input
                    ...
                    (ngModelChange)="
                      helper.updateField('clear_selection_on_clipboard_loss', $event)
                    "
                  ...
                  <div>
                    <span class="text-sm font-medium text-kitty-text"
                      >Clear Selection on Clipboard Loss</span
                    >
                    <p class="text-kitty-text-dim text-xs mt-0.5">
                      Clear visual selection when clipboard changes (Linux primary selection)
                    </p>
                  </div>
                </label>
