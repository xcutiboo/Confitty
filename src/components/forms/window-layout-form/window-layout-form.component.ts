    ...
    >
        ...
        <label class="flex items-center gap-3 cursor-pointer">
          ...
          <div>
            ...
            <p class="text-kitty-text-dim text-xs mt-0.5">
              Restore the last window dimensions on startup. Not available on Wayland.
            </p>
          </div>
        </label>
      </div>
      ...
      <div class="form-group">
        <label class="flex items-center gap-3 cursor-pointer">
          ...
          <div>
            ...
            <p class="text-kitty-text-dim text-xs mt-0.5">
              Restore the last window position on startup. Not available on Wayland.
            </p>
          </div>
        </label>
      </div>
        ...
        <div class="form-group">
          <label class="block text-sm font-medium text-kitty-text mb-2">
            ...
            <span class="text-kitty-text-dim text-xs ml-2"
              >Used when remember_window_size is off</span
            >
          </label>
          <app-number-input
      ...
      <div class="form-group">
        <label class="block text-sm font-medium text-kitty-text mb-3">
          Enabled Layouts
          <span class="text-kitty-text-dim text-xs ml-2"
            >Select which tiling layouts are available via
            <code class="bg-kitty-bg px-1 rounded font-mono">next_layout</code></span
          >
        </label>
      ...
      <div class="form-group">
        <label class="block text-sm font-medium text-kitty-text mb-2">
          ...
          <span class="text-kitty-accent font-bold ml-2"
            >{{ windowLayout().window_padding_width }}px</span
          >
        ...
        <div class="bg-kitty-surface rounded-lg p-6 border border-kitty-border">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                Window Margin Width
                <span class="text-kitty-accent font-bold ml-2"
                  >{{ windowLayout().window_margin_width }}px</span
                >
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-accent font-bold ml-2"
                  >{{ windowLayout().single_window_margin_width }}px</span
                >
                <span class="text-kitty-text-dim text-xs ml-1"
                  >Override for single-pane mode (-1 = use above)</span
                >
              </label>
              <app-slider-input
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-accent font-bold ml-2"
                  >{{ windowLayout().single_window_padding_width }}px</span
                >
                <span class="text-kitty-text-dim text-xs ml-1"
                  >Override for single-pane mode (-1 = use above)</span
                >
            ...
            <div class="form-group">
              <label class="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  (ngModelChange)="
                    helper.updateField('draw_window_borders_for_single_window', $event)
                  "
                  class="w-5 h-5 rounded flex-shrink-0"
                />
                <div>
                  <span class="text-sm font-medium text-kitty-text"
                    >Draw Window Borders for Single Window</span
                  >
                  <p class="text-kitty-text-dim text-xs mt-0.5">
                    Draw borders around single-pane windows
                  </p>
                </div>
              </label>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Cells per resize step (0 = disable resizing in steps)</span
                >
              </label>
              <app-number-input
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Lines per resize step (0 = disable resizing in steps)</span
                >
              </label>
              <app-number-input
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                Inactive Text Alpha
                <span class="text-kitty-accent font-bold ml-2"
                  >{{ (windowLayout().inactive_text_alpha * 100).toFixed(0) }}%</span
                >
                <span class="text-kitty-text-dim text-xs ml-1"
                  >Opacity of text in unfocused panes</span
                >
              </label>
              <app-slider-input
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="form-group">
              <label class="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-kitty-text-dim text-xs mt-0.5">
                    Only draw borders where adjacent panes touch
                  </p>
                </div>
              </label>
            </div>
            ...
            <div class="form-group">
              <label class="block text-sm font-medium text-kitty-text mb-2">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Control OS window chrome visibility</span
                >
              </label>
              <select
              ...
              <p class="text-kitty-text-dim text-xs mt-1">
                "titlebar-only" and "titlebar-and-corners" require Kitty 0.46+
              </p>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="form-group">
                <label class="block text-sm font-medium text-kitty-text mb-2">
                  Logo Path
                  <span class="text-kitty-text-dim text-xs ml-2"
                    >PNG image to display in window corner</span
                  >
                </label>
                <input
                  type="text"
            ...
            <div class="form-group mt-4" [class.opacity-60]="!windowLogoScaleAvailable()">
              <div class="flex items-center gap-2 mb-2">
                <label class="block text-sm font-medium text-kitty-text">
                  Logo Scale
                  <span class="text-kitty-text-dim text-xs ml-2"
                    >Relative scale of logo (0 = auto size)</span
                  >
                </label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="form-group">
                <label class="block text-sm font-medium text-kitty-text mb-2">
                  ...
                  <span class="text-kitty-text-dim text-xs ml-2"
                    >Delay in ms before resizing (0 = instant)</span
                  >
                </label>
                <app-number-input
          ...
          <div class="form-group mt-4">
            <label class="block text-sm font-medium text-kitty-text mb-2">
              ...
              <span class="text-kitty-text-dim text-xs ml-2"
                >Characters for visual window selection (e.g., "1234567890")</span
              >
            </label>
            <input
              type="text"
          ...
          <div class="form-group mt-4" [class.opacity-60]="!placementStrategyAvailable()">
            <div class="flex items-center gap-2 mb-2">
              <label class="block text-sm font-medium text-kitty-text">
                Placement Strategy
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Window placement strategy for tiling WMs</span
                >
              </label>
          ...
          <div class="form-group mt-4" [class.opacity-60]="!windowDragToleranceAvailable()">
            <div class="flex items-center gap-2 mb-2">
              <label class="block text-sm font-medium text-kitty-text">
                ...
                <span class="text-kitty-text-dim text-xs ml-2"
                  >Drag region in pts around borders for mouse resize (0 = disable)</span
                >
              </label>
          ...
          <div class="form-group mt-4">
            <label class="block text-sm font-medium text-kitty-text mb-2">
              ...
              <span class="text-kitty-text-dim text-xs ml-2"
                >Number of windows requiring confirmation (-1 = always, 0 = never)</span
              >
            </label>
            <app-number-input
