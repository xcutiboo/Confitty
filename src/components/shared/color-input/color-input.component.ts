...
export class ColorInputComponent {
	...
	readonly sizeClasses = {
		sm: {
			picker:
				"w-10 h-8 rounded cursor-pointer bg-kitty-surface border border-kitty-border flex-shrink-0",
		...
		md: {
			picker:
				"w-14 h-10 rounded-lg cursor-pointer bg-kitty-bg border border-kitty-border flex-shrink-0",
		...
		lg: {
			picker:
				"w-16 h-12 rounded-lg cursor-pointer bg-kitty-bg border border-kitty-border flex-shrink-0",
