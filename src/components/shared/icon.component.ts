...
const ICONS = {
  ...
  preview:     'M2 5a2 2 0 012-2h16a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5z M8 21h8m-4-4v4',
  ...
  palette:     'M12 2a10 10 0 100 20c1.7 0 3-1.4 3-3 0-.9-.3-1.6-.9-2.1-.4-.4-.6-1-.6-1.7 0-1.2 1-2.2 2.2-2.2H17a5 5 0 005-5 10 10 0 00-10-10z M7 13a1 1 0 100-2 1 1 0 000 2z M10 8a1 1 0 100-2 1 1 0 000 2z M15 8a1 1 0 100-2 1 1 0 000 2z M18 13a1 1 0 100-2 1 1 0 000 2z',
  // Misc
  ...
  heart:       'M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 00-7.8 7.8l1.1 1.1L12 21l7.8-7.8 1.1-1.1a5.5 5.5 0 000-7.8z',
  star:        'M12 2l3.1 6.3 6.9 1-5 4.9 1.2 6.8L12 17.8 5.8 21l1.2-6.8L2 9.3l6.9-1L12 2z',
  refresh:     'M3 12a9 9 0 0115.5-6.3L21 8 M21 4v4h-4 M21 12a9 9 0 01-15.5 6.3L3 16 M3 20v-4h4',
  ...
  external:    'M14 3h7v7 M10 14L21 3 M21 14v6a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1h6',
